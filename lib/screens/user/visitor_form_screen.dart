  ...
  Future<void> _fetchNameIfNeeded() async {
    ...
    try {
      final response = await http.get(
        Uri.parse('http://192.168.1.51:3000/externos/${widget.dni}'),
      );
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final response = await http.post(
          Uri.parse('http://192.168.1.51:3000/visitas'),
        ...
        await http.post(
          Uri.parse('http://192.168.1.51:3000/externos'),
          headers: {'Content-Type': 'application/json'},
        ...
        if (_selectedFaculty != null) {
          final guardsResponse = await http.get(
            Uri.parse('http://192.168.1.51:3000/usuarios?puerta_acargo=$_selectedFaculty&rango=guardia'),
          );
          if (guardsResponse.statusCode == 200) {
            ...
            for (var guard in guardsList) {
              ...
              await http.post(
                Uri.parse('http://192.168.1.51:3000/notificaciones'),
                headers: {'Content-Type': 'application/json'},
